...
const PurchasePage = () => {
  ...
  useEffect(() => {
    fetch(`   https://mountain-bike-server.vercel.app/purchasePage/${id}`)
      .then((res) => res.json())
  ...
  const onSubmit = async (data) => {
    ...
    fetch("    https://mountain-bike-server.vercel.app/order", {
      method: "POST",
      headers: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20 gap-5">
          <div className="card shadow-2xl border ">
            ...
            <div className="card-body text-white">
              ...
              <p>
                <span className="text-4xl">${part.price}</span> (Per parts
                price)
              </p>
              <div class="rating">
                <input
